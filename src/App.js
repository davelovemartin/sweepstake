...
function App() {
  return (
    <React.Fragment>
      {/* @todo - set the scene: what is this? above the fold... first glance */}
      ...
      {/* @todo - what are the steps the user needs to take in this app? */}
      {/* @todo - what happens afterwards - how can you inform the user here?       */}
